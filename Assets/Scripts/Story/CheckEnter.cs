...
{
    public static int EnterSecrethouse; //포지션을 위한변수
    public static int EnterSecretbattle;
    public static int FromCitytoMiro;
    public static int FromMirotoGaia;
    public static int FromGaiatofight;
    public static int FromAreatoBoss;
    public static int FromAreatoFire;
    ...
    public static int FromDeserttoRo;
    public static int FromOctoOthouse;
    public static int FromOctoCrab;
    public static int FromOctoDerrick;
    public static int FromDetoSo;
    public static int FromOctoPo;
}
